 ...
 * @e_ident: This represents a pointer to an array containing
 * the ELF magic numbers.
 *
 * Description:  This function exit code 98, if the file is not an ELF file.
 */
 ...
 * @e_ident: This represents a pointer to an array containing the
 * ELF magic numbers.
 *
 * Description:  In this function, magic numbers are separated by spaces.
 */
 ...
 * @e_ident:   This represents a pointer to an array containing the ELF class.
 */
 ...
 * @e_ident:  This represents a pointer to an array containing the ELF version.
 */
 ...
 *
 * Description: In this function, exit code 98 , if the file cannot be closed.
 */
...
/**
 * main -This main functio  displays the information contained in the
 ...
 *
 * Description: In this function, if the file is not an ELF File or
